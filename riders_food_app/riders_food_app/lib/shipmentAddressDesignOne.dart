...
import 'package:riders_food_app/parcel_picking_screen_one.dart';
...
class ShipmentaddressdesignOne extends StatelessWidget {
  final Address? model;
  ...
  const ShipmentaddressdesignOne({
    Key? key,
    this.model,
    this.orderStatus,
    this.orderId,
  ...
  confirmedParcelShipment(BuildContext context, String getOrderID,
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: ((context) => ParcelPickingScreenOneTwo(
